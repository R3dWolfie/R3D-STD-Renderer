...
from osu_std_renderer.beatmap.storyboard import Origin
from osu_std_renderer.render.storyboard_render import (
...
def test_storyboard_gl_smoke():
    ...
    from osu_std_renderer.beatmap.storyboard import parse_storyboard_text
    from osu_std_renderer.render.storyboard_engine import StoryboardEngine
    from osu_std_renderer.render.storyboard_render import StoryboardRenderer
